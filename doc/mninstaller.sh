...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='enceladus.conf'
CONFIGFOLDER='/root/.enceladus'
COIN_DAEMON='enceladusd'
COIN_CLI='enceladus-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/enceladusproject/enceladus_coin.git'
COIN_TGZ=''
