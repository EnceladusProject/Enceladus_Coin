...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/enceladus-cli.cpp \
           src/enceladus-tx.cpp \
           src/enceladus.cpp \
           src/db.cpp \
           ...
           src/qt/enceladus.cpp \
           src/qt/enceladusstrings.cpp \
...
RESOURCES += src/qt/enceladus.qrc src/qt/enceladus_locale.qrc

TRANSLATIONS += src/qt/locale/enceladus_bg.ts \
                src/qt/locale/enceladus_de.ts \
                src/qt/locale/enceladus_en.ts \
                src/qt/locale/enceladus_es.ts \
                src/qt/locale/enceladus_fi.ts \
                src/qt/locale/enceladus_fr.ts \
                src/qt/locale/enceladus_it.ts \
                src/qt/locale/enceladus_ja.ts \
                src/qt/locale/enceladus_pl.ts \
                src/qt/locale/enceladus_pt.ts \
                src/qt/locale/enceladus_ru.ts \
                src/qt/locale/enceladus_sk.ts \
                src/qt/locale/enceladus_sv.ts \
                src/qt/locale/enceladus_vi.ts \
                src/qt/locale/enceladus_zh_CN.ts \
                src/qt/locale/enceladus_zh_TW.ts
