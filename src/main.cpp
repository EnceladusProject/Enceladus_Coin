...
#if defined(NDEBUG)
#error "Enceladus cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Enceladus Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) return 610000 * COIN;
...
{
	int64_t ret = blockValue * (mnCollateral / 1000 / COIN);
...
{
    RenameThread("enceladus-scriptch");
