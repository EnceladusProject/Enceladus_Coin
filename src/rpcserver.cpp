...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Enceladus server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Enceladus server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ENCP features */
        {"enceladus", "masternode", &masternode, true, true, false},
        {"enceladus", "masternodelist", &masternodelist, true, true, false},
        {"enceladus", "mnbudget", &mnbudget, true, true, false},
        {"enceladus", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"enceladus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"enceladus", "mnsync", &mnsync, true, true, false},
        {"enceladus", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"enceladus", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use enceladusd, or the -server option to enceladus-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=enceladusrpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"Enceladus Alert\" admin@foo.com\n"),
...
{
    return "> enceladus-cli " + methodname + " " + args + "\n";
}
