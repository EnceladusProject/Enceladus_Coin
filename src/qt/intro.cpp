...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Enceladus Core"),
     ...
     * override -datadir in the enceladus.conf file in the default data directory
     * (to be consistent with enceladusd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
