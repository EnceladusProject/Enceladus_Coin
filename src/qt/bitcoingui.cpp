                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Enceladus-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Enceladus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and enceladus: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Enceladus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Enceladus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Enceladus"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Enceladus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Enceladus addresses"));
    ...
    openAction->setStatusTip(tr("Open a Enceladus: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Enceladus Core help message to get a list with possible Enceladus command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Enceladus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Enceladus network", "", count));
}
...
{
    QString strTitle = tr("Enceladus Core"); // default title
