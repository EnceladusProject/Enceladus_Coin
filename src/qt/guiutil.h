...
/** Utility functions used by the ENCP Qt UI.
 */
namespace GUIUtil
{
...
// Render ENCP addresses in monospace font
...
// Parse "enceladus:" URI into recipient object, return true on successful parsing
