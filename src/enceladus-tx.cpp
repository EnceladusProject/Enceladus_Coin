...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Enceladus Core enceladus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  enceladus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded enceladus transaction") + "\n" +
                               "  enceladus-tx [options] -create [commands]   " + _("Create hex-encoded enceladus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded enceladus transaction
